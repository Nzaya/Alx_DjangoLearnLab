...
# Add XSS and other browser protections
SECURE_BROWSER_XSS_FILTER = True  # Enable browser XSS filtering
X_FRAME_OPTIONS = 'DENY'  # Prevent your site from being embedded in a frame (X-Frame-Options)
...
# Configure Django to trust the X-Forwarded-Proto header from a proxy
...
CSP_IMG_SRC = ("'self'", "https://trusted.cdn.com")  # Allow images from trusted sources
CSP_CONNECT_SRC = ("'self'",)  # Allow connections from the same origin
CSP_FRAME_ANCESTORS = ("'none'",)  # Prevent the site from being embedded in a frame
